            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" class="mb-5" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="deskripsi_profile" class="col-md-4 col-form-label text-md-end">{{ __('Deskripsi Pofile') }}</label>

                            <div class="col-md-6">
                                <input id="deskripsi_profile" type="text" class="form-control @error('deskripsi_profile') is-invalid @enderror" name="deskripsi_profile" value="{{ old('deskripsi_profile') }}" required autocomplete="deskripsi_profile" autofocus>

                                @error('deskripsi_profile')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
