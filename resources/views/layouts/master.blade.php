    ...
    <body>
                    ...
                    <div class="col-md-3" style="margin-top: 35px;">
                        <div class="card">
                            {{-- <a href="#modal_{{$foto->id_photo}}" data-lightbox="mygallery" data-title="A beatiful"> --}}
                                <div class="show_image"><a href="{{ asset('storage/' . $foto->image) }}"><img style="width: 305px; height: 280px;" src="{{ asset('storage/' . $foto->image) }}" ></a></div>
                                ...
                                <div style="margin-left: 5px;" >
                                    <p>{{ $foto->describe_photo }}</p>
                                            ...
                                            <div style="display: flex">
                                                <p>4</p>
                                                <a href="#modal_{{$foto->id_photo}}" data-toggle="modal"><i style="font-size: 25px; margin-right: 5px; margin-left: 5px; color: #555;" id="icon2" class="fa fa-comment-dots"></i><a>
                                            </div>
                                            <button id="shareButton" style="border: none; background: transparent;"><i style="font-size: 25px; margin-left: 5px; margin-bottom: 25px; color: #555" id="icon3" class="fa fa-share" ></i></button>
                                            @endif
                                        </div>
                                </div>
                        </div>
                        ...
                        <div class="modal-dialog" style="width: 600px">
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="desc-post" style="padding: 18px; margin-bottom: 10px">
                                        {{-- {{ $foto->describe_photo }} --}}
                                    ...
                                    <div class="pull-footer" style="background-color: #e0e0eb; height: 35px; border-radius: 8px">
                                        <span class="user-info">by user</span>
                                        <span class="user-time" style="float: right">waktu</span>
                                    </div>
                                    <br>
                                    <h4>Comment nih :</h4>
                                    <form action="{{route('tambahKomen',$foto->id_photo)}}" method="post">
                                        ...
                                        <button class="btn btn-success" style="margin-top: 5px; width: 100%" type="submit">Kirim</button>
                                    </form>
                                    <hr>
                                    ...
                                    <div class="comment-list" style="margin-top: 8px">
                                            ...
                                            @foreach($foto->komens as $comment)
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="/src/img/carousel-2.jpg" class="img-fluid w-100" alt="First slide">
                    ...
                    <div class="carousel-item">
                        <img src="/src/img/carousel-1.jpg" class="img-fluid w-100" alt="Second slide">
                        <div class="carousel-caption">
                            <div class="container carousel-content">
                                <h4 class="text-white mb-4 animated slideInDown">No 1 Pest Control Services</h4>
                                <h1 class="text-white display-1 mb-4 animated slideInDown">Enjoy Your Home Totally Pest Free</h1>
                ...
                <div class="row g-5">
                    <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".3s">
                        <div class="about-img">
                            ...
                            <img src="/src/img/about-img.jpg" class="img-fluid h-100" alt="img">
                ...
                <div class="row g-5">
                    <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".3s">
                        <div class="project-item">
                            ...
                            <img src="/src/img/project-1.jpg" class="img-fluid h-100" alt="img">
                    ...
                    <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".5s">
                        <div class="project-item">
                            <div class="project-left bg-dark"></div>
                            <div class="project-right bg-dark"></div>
                            <img src="/src/img/project-2.jpg" class="img-fluid h-100" alt="img">
                    ...
                    <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".7s">
                        <div class="project-item">
                            <div class="project-left bg-dark"></div>
                            <div class="project-right bg-dark"></div>
                            <img src="/src/img/project-3.jpg" class="img-fluid h-100" alt="img">
                    ...
                    <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".3s">
                        <div class="project-item">
                            <div class="project-left bg-dark"></div>
                            <div class="project-right bg-dark"></div>
                            <img src="/src/img/project-4.jpg" class="img-fluid h-100" alt="img">
                    ...
                    <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".5s">
                        <div class="project-item">
                            <div class="project-left bg-dark"></div>
                            <div class="project-right bg-dark"></div>
                            <img src="/src/img/project-5.jpg" class="img-fluid h-100" alt="img">
                    ...
                    <div class="col-xxl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".7s">
                        <div class="project-item">
                            <div class="project-left bg-dark"></div>
                            <div class="project-right bg-dark"></div>
                            <img src="/src/img/project-6.jpg" class="img-fluid h-100" alt="img">
        ...
        {{-- <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <div class="owl-carousel blog-carousel wow fadeInUp" data-wow-delay=".5s">
                    <div class="blog-item">
                        <img src="/src/img/blog-1.jpg" class="img-fluid w-100 rounded-top" alt="">
                    ...
                    <div class="blog-item">
                        <img src="/src/img/blog-3.jpg" class="img-fluid w-100 rounded-top" alt="">
                         <div class="rounded-bottom bg-light">
                            <div class="d-flex justify-content-between p-4 pb-2">
                                <span class="pe-2 text-dark"><i class="fa fa-user me-2"></i>By Admin</span>
                                <span class="text-dark"><i class="fas fa-calendar-alt me-2"></i>10 Feb, 2023</span>
                    ...
                    <div class="blog-item">
                        <img src="/src/img/blog-2.jpg" class="img-fluid w-100 rounded-top" alt="">
                         <div class="rounded-bottom bg-light">
                            <div class="d-flex justify-content-between p-4 pb-2">
                                <span class="pe-2 text-dark"><i class="fa fa-user me-2"></i>By Admin</span>
                                <span class="text-dark"><i class="fas fa-calendar-alt me-2"></i>10 Feb, 2023</span>
        ...
        {{-- <div class="container-fluid py-5 call-to-action wow fadeInUp" data-wow-delay=".3s" style="margin: 6rem 0;">
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-6">
                        <img src="/src/img/action.jpg" class="img-fluid w-100 rounded-circle p-5" alt="">
                    </div>
                ...
                <div class="row g-5">
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".3s">
                        <div class="rounded team-item">
                            <img src="/src/img/team-1..jpg" class="img-fluid w-100 rounded-top border border-bottom-0" alt="">
                    ...
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".5s">
                        <div class="rounded team-item">
                            <img src="/src/img/team-2.jpg" class="img-fluid w-100 rounded-top border border-bottom-0" alt="">
                            <div class="team-content bg-primary text-dark text-center py-3">
                                <span class="fs-4 fw-bold">Full Name</span>
                                <p class="text-muted mb-0">Designation</p>
                            </div>
                    ...
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".7s">
                        <div class="rounded team-item">
                            <img src="/src/img/team-3.jpg" class="img-fluid w-100 rounded-top border border-bottom-0" alt="">
                            <div class="team-content bg-primary text-dark text-center py-3">
                                <span class="fs-4 fw-bold">Full Name</span>
                                <p class="text-muted mb-0">Designation</p>
                            </div>
                    ...
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".9s">
                        <div class="rounded team-item">
                            <img src="/src/img/team-4.jpg" class="img-fluid w-100 rounded-top border border-bottom-0" alt="">
                            <div class="team-content bg-primary text-dark text-center py-3">
                                <span class="fs-4 fw-bold">Full Name</span>
                                <p class="text-muted mb-0">Designation</p>
                            </div>
            ...
            <div class="container py-5">
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay=".5s">
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center  mb-4" style="padding: 0 0 0 25px;">
                            <div class="position-relative">
                                <img src="/src/img/testimonial-1.jpg" class="img-fluid rounded-circle py-2" alt="">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center  mb-4" style="padding: 0 0 0 25px;">
                            <div class="position-relative">
                                <img src="/src/img/testimonial-2.jpg" class="img-fluid rounded-circle py-2" alt="">
                                <div class="position-absolute" style="top: 33px; left: -25px;">
                                    <i class="fa fa-quote-left rounded-pill bg-primary text-dark p-3"></i>
                                </div>
                            </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center  mb-4" style="padding: 0 0 0 25px;">
                            <div class="position-relative">
                                <img src="/src/img/testimonial-3.jpg" class="img-fluid rounded-circle py-2" alt="">
                                <div class="position-absolute" style="top: 33px; left: -25px;">
                                    <i class="fa fa-quote-left rounded-pill bg-primary text-dark p-3"></i>
                                </div>
                            </div>
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center  mb-4" style="padding: 0 0 0 25px;">
                            <div class="position-relative">
                                <img src="/src/img/testimonial-4.jpg" class="img-fluid rounded-circle py-2" alt="">
                                <div class="position-absolute" style="top: 33px; left: -25px;">
                                    <i class="fa fa-quote-left rounded-pill bg-primary text-dark p-3"></i>
                                </div>
                            </div>
